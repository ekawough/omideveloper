...
Business Source License 1.1 (BSL). Free for personal/educational/non-commercial
use. You may not use this to run a competing commercial hosted service.
Converts to MIT on 2030-04-15. See [LICENSE](LICENSE) for details.

Third-party model licenses vary (SenseVoice MIT, emotion2vec MIT,
SpeechBrain Apache 2.0, Llama 3.1 Meta Community).
